        ...
        partnerUserRef:
          schema:
            - type: string
              required: true
              description: >-
                The `partnerUserId` parameter used to initialize the Onramp
                Widget
      query:
        pageKey:
          schema:
              ...
              transactions:
                allOf:
                  - description: List of transactions matching the `partnerUserId`
                    ...
                    type: array
            description: Get Onramp Transactions by ID API response
            refIdentifier: '#/components/schemas/GetTransactionsForPartnerUserResponse'
        examples:
          example:
            value:
              nextPageKey: <string>
